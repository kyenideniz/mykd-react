                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-6">
                            <div className="slider__content">
                                <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">merhaba gökhan bey</h6>
                                <h2 className="title wow fadeInUp" data-wow-delay=".5s">TEMANIZ</h2>
                                <p className="wow fadeInUp" data-wow-delay=".8s">GÜZELMİŞ FAZLASIYLA</p>
                                <div className="slider__btn wow fadeInUp" data-wow-delay="1.2s">
                                    <NavLink to="/contact" className="tg-btn-1"><span>Hazır mıyız</span></NavLink>
                                </div>
                            </div>
                        </div>
